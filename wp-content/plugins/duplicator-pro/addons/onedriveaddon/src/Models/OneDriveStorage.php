...
class OneDriveStorage extends AbstractStorageEntity implements StorageAuthInterface
{
    ...
    protected function getAdapter()
    {
        if (!$this->adapter) {
            ...
            $this->adapter = new OneDriveAdapter(
                ...
                DynamicGlobalEntity::getInstance()->getVal('onedrive_http_version', OnedriveAdapter::HTTP_VERSION_AUTO)
            );
    ...
    {
        return [
            'onedrive_http_version'             => OnedriveAdapter::HTTP_VERSION_AUTO,
    ...
    public static function renderGlobalOptions()
    {
        ...
        TplMng::getInstance()->render(
            ...
            [
                ...
                'httpVersion'       => $dGlobal->getVal('onedrive_http_version', OnedriveAdapter::HTTP_VERSION_AUTO),
            ]
        );
    }
}
