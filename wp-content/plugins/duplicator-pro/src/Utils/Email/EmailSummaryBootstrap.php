...
class EmailSummaryBootstrap
{
    ...
    public static function init()
    {
        ...
        add_action('duplicator_pro_transfer_failed', function (DUP_PRO_Package_Upload_Info $uploadInfo) {
        ...
        add_action('duplicator_pro_transfer_cancelled', function (DUP_PRO_Package_Upload_Info $uploadInfo) {
            if ($uploadInfo->isDownloadFromRemote()) {
                return;
            }
        ...
        add_action('duplicator_pro_upload_complete', function (DUP_PRO_Package_Upload_Info $uploadInfo) {
            if ($uploadInfo->isDownloadFromRemote()) {
                return;
            }
    ...
    public static function send()
    {
        ...
        $siteDomain    = (isset($parsedHomeUrl['host']) ? $parsedHomeUrl['host'] : '');
