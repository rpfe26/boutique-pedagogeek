...
$packageUploaded                  = new DUP_PRO_UI_Messages(__('Backup uploaded', 'duplicator-pro'), DUP_PRO_UI_Messages::NOTICE);
...
$packageCancelUpload                  = new DUP_PRO_UI_Messages(__('Backup upload cancelled', 'duplicator-pro'), DUP_PRO_UI_Messages::ERROR);
...
$packageRemoved                  = new DUP_PRO_UI_Messages(__('Backup removed', 'duplicator-pro'), DUP_PRO_UI_Messages::NOTICE);
    ...
    jQuery(document).ready(function ($) {
        ...
        DupPro.ImportManager = {
            ...
            initRemoteUpload: function () {
                $('#dup-pro-import-remote-upload').click(function () {
                    ...
                    try {
                        ...
                        DupPro.addAdminMessage('<?php echo esc_js(__('Invalid URL', 'duplicator-pro')) ?>', 'error');
                    }
            ...
            isValidFileName: function (name) {
                if (!name.match(<?php echo wp_json_encode(DUPLICATOR_PRO_ARCHIVE_REGEX_PATTERN); ?>)) {
                    return false;
                }
                return true;
            },
